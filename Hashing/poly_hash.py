...
#NittinS Snippets
    ...
    @staticmethod
    def splitmix64(x):
        x&=RollingHash64.MASK
        x=(x+0x9e3779b97f4a7c15)&RollingHash64.MASK
        x=(x^(x>>30))*0xbf58476d1ce4e5b9&RollingHash64.MASK
        x=(x^(x>>27))*0x94d049bb133111eb&RollingHash64.MASK
        return (x^(x>>31))&RollingHash64.MASK
